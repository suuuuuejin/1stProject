...
public class BuySearchListController implements Controller {
	...
	public String requestProcessor(HttpServletRequest request, HttpServletResponse response)
		...
		board.setAllPageCount(dao.buysearchListCount(m));
		System.out.println(dao.buysearchListCount(m));
		...
		List<Buy_Board> list=dao.buysearchList(m);

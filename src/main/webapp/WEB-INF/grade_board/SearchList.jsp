                  ...
                  <tbody id="list">
                  	<c:forEach  var="vo" items="${list2 }"> 
    					<tr>
			    			...
			    			<td><a href="${cpath }/boardView.do?num=${vo.grade_seq}&p=${board2.currentPage}&login_id=${mvo.login_id}" class="text-reset">${vo.grade_title }<span class="text-orange">&nbsp;[${vo.grade_cmtcnt }]</span></a></td>
              ...
              <div class="card-footer d-flex align-items-center py-2">
                ...
                <c:if test="${board2.pagingPerCount<board2.start_page}">
                  <li class="page-item abled">
                    <a class="page-link" href="${cpath }/gradeSearch.do?p=${board2.start_page-1}&val=${val}&text=${text}" tabindex="-1" aria-abled="true">
				    ...
				    <c:forEach var="i" begin="${board2.start_page}" end="${board2.end_page}">
				    	...
				    	<c:otherwise>
					    <li class="page-item"><a class="page-link" href="${cpath }/gradeSearch.do?p=${i}&val=${val}&text=${text}">${i}</a></li>
					    </c:otherwise>
					    </c:choose>
				    </c:forEach>
				...
				<c:if test="${board2.numPageCount>board2.end_page}">
					<li class="page-item abled"><a class="page-link" href="${cpath }/gradeSearch.do?p=${board2.end_page+1}&val=${val}&text=${text}" tabindex="1" aria-abled="true">next
					<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" 
                      stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" 
                      stroke-linejoin="round">
